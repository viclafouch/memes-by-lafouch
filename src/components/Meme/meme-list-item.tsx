    ...
    return (
      <motion.div className="relative flex w-full flex-col gap-2 text-sm sm:min-w-0 group">
        ...
        >
          ...
          />
          <button
            className="absolute inset-0 opacity-0 scale-0 group-hover:opacity-100 group-hover:scale-100 transition-all z-20 delay-75 cursor-pointer text-white/80 place-items-center group-focus-within:opacity-100 group-focus-within:scale-100 outline-none"
            type="button"
            onClick={(event) => {
