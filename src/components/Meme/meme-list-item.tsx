      ...
      <motion.div className="relative flex w-full flex-col gap-2 text-sm sm:min-w-0 group">
        ...
        >
          ...
          <img
            ...
            alt={meme.title}
            className="absolute w-full h-full inset-0 hidden duration-600 group-hover:block transition-discrete z-10 object-cover opacity-0 group-hover:opacity-100"
          />
          <button
            className="absolute inset-0 opacity-0 scale-0 group-hover:opacity-100 group-hover:scale-100 transition-all z-20 delay-75 cursor-pointer text-white/80 place-items-center"
            type="button"
            onClick={(event) => {
